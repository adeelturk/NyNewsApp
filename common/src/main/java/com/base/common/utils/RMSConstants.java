...
public class RMSConstants {
    ...
    public static final String WHICH_REQUEST ="whichRequest";
    private static final float BITMAP_SCALE = 0.4f;
    private static final int BLUR_RADIUS = 8;
    public static final String COUNT = "count";
    public static final String ACTION = "action";
    public static final String REFRESH_DATA = "refresh";
    public static final String REFRESH_DATA_ONLINE = "refresh_is_online";


    public static final String PLATENUMBER="PlateNumber";
    public static final String PLATESOURCE="PlateSource";
    public static final String PLATEKIND="PlateKind";
