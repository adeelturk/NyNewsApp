package com.data.dtos.serverObjects
...
{
    fun toView() = NewsView(id=id,title=title,abstract=abstract,authors = byline,date = published_date,pictures = media.map { it.toView() }.flatten())
}
